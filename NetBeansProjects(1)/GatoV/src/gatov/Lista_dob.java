...
public class Lista_dob<gen>{
     ...
     * @param e
     */
    public void insertarUltimo(gen e){
    ...
    public void addlistend(Lista_dob<gen> li){
        li.primero();
        if(li.lenght==0) return;
        
        for(int i=1;i<=li.lenght;++i){
            insertarUltimo(li.elemento());
            li.avanza();
        }//for 
        li.primero();
    }//addlist
