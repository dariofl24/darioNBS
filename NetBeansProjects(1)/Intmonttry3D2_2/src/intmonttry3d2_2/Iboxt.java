...
public class Iboxt {
    ...
    public void storew(double s,String inf,double ID){
        
        try{
            writer= new BufferedWriter(new FileWriter("IntVal.dat",true));
            writer.write(""+ID); writer.newLine();
            writer.write(""+s); writer.newLine();
            writer.write(time()+inf); writer.newLine();
            writer.close();
    ...
    public synchronized void store(double s,String inf,double ID){
        double a=0,b=0;
    ...
    public void errorinf(double[] fval){
        try{
            BufferedWriter wrt= new BufferedWriter(new FileWriter("fval.dat",true));
            ...
            System.out.println("Write File er");
            errorinf(fval);
        }//try-catch
    ...
    public double geterror(boolean flag,double n,double Vt){
        ...
        try{
            ...
            while(s!=null){
                ...
                sum= sum + Math.pow( Double.parseDouble(s.trim())-eproms ,2);
