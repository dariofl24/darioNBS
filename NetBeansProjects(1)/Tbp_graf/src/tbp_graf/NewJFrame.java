...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public NewJFrame() {
        ...
        try{
            w1= new BufferedWriter(new FileWriter("dat1.txt"));
            w2= new BufferedWriter(new FileWriter("dat2.txt"));
            w3= new BufferedWriter(new FileWriter("dat3.txt"));
        }catch(IOException e){
    ...
    private void initComponents() {
        ...
        jcb_file = new javax.swing.JCheckBox();
        ...
        jcb_file.setText("File");
        jcb_file.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                jcb_fileStateChanged(evt);
            }
        });
        jcb_file.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcb_fileActionPerformed(evt);
            }
        });
        ...
        jFrame1Layout.setHorizontalGroup(
            ...
            .addGroup(jFrame1Layout.createSequentialGroup()
                ...
                .addGroup(jFrame1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jtf_file, javax.swing.GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE)
                    .addComponent(jcb_file))
                .addContainerGap())
        );
            ...
            .addGroup(jFrame1Layout.createSequentialGroup()
                ...
                .addGroup(jFrame1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jFrame1Layout.createSequentialGroup()
                        ...
                        .addComponent(jComboBox1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtf_file, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jcb_file)
    ...
    private void jcb_fileStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jcb_fileStateChanged

    }//GEN-LAST:event_jcb_fileStateChanged

    private void jcb_fileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcb_fileActionPerformed
        file_flag= !file_flag;
        System.out.println(file_flag);
    }//GEN-LAST:event_jcb_fileActionPerformed
    ...
    private void simulation_f(){
        String file="",line="";
        float xa1=0,xa2=0,xa3=0,ya1=0,ya2=0,ya3=0;
        float xb1=0,xb2=0,xb3=0,yb1=0,yb2=0,yb3=0;
        int turn=0;
        boolean xas=true;
        
        file=jtf_file.getText();
        if(file==null){start=false; return;}
        file= file.trim();
        if(file.equalsIgnoreCase("")){start=false; return;}
        ...
        try{
            ...
            while(line!=null){
                ...
                switch(turn){
                    ...
                    case 0:
                        if(xas){
                            xa1=Float.parseFloat(line);
                        }else{
                            xb1=Float.parseFloat(line);
                        }//if-else
                        break;
                    case 1:
                        if(xas){
                            ya1=Float.parseFloat(line);
                        }else{
                            yb1=Float.parseFloat(line);
                        }//if-else
                        break;
                    case 2:
                        if(xas){
                            xa2=Float.parseFloat(line);
                        }else{
                            xb2=Float.parseFloat(line);
                        }//if-else
                        break;
                    case 3:
                        if(xas){
                            ya2=Float.parseFloat(line);
                        }else{
                            yb2=Float.parseFloat(line);
                        }//if-else
                        break;
                    case 4:
                        if(xas){
                            xa3=Float.parseFloat(line);
                        }else{
                            xb3=Float.parseFloat(line);
                        }//if-else
                        break;
                    case 5:
                        if(xas){
                            ya3=Float.parseFloat(line);
                        }else{
                            yb3=Float.parseFloat(line);
                        }//if-else
                        break;
                }//switch
                ...
                if((!xas) && (turn==5)){
                    ...
                    Draw(xa1,ya1,xb1,yb1,1);
                    Draw(xa2,ya2,xb2,yb2,2);
                    Draw(xa3,ya3,xb3,yb3,3);
    ...
    private void Draw(float x1,float y1,float x2,float y2,int turn){
        ...
        if(o1==15){ graf.drawOval(xa2, ya2,8,8); o1=0; }
        
    }//Draw
    
    private void writef(float x,float y,int turn,int ln){
    ...
    private javax.swing.JCheckBox jcb_file;
