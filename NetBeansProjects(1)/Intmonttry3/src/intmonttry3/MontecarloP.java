...
public class MontecarloP extends Thread {
    ...
    public MontecarloP(FunctionR9 f,double rmin,double rmax,double lim,Iboxt Box,double tt,double id){
        fun=f;
        Rmin= rmin;
        Rmax= rmax;
        Lim= lim;
    ...
    public MontecarloP(FunctionR9 f,double rmin,double rmax,double lim,Iboxt Box,double tt,Lista_dob<MontecarloP> lt,double id){
        fun=f;
        Rmin= rmin;
        Rmax= rmax;
        Lim= lim;
    ...
    public void run(){
        ...
        if(!flag){
            ...
            info= info+"IntegralC:"+ival+"\n"+"Error:"+error+"\n";
            if(TT==box.sum(ival,info)){
                box.printinfo();
