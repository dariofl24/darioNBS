...
public class FunctionR9 {
    ...
    private double funA(double q11,double q12,double q13,double q21,double q22,double q23){
    ...
    private double funB(double q11,double q12,double q13,double q21,double q22,double q23,double q31,double q32,double q33){
