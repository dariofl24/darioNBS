...
public class SFTP_try {
	...
	String cmd=(String)cmds.get(0); System.out.println(">>> cmd: "+cmd);
	if(cmd.equals("quit")){
          c.quit();
	  break;
	}
	if(cmd.equals("exit")){
 	...
 	if(cmd.equals("compression")){
	  ...
	  try{
	    level=Integer.parseInt((String)cmds.get(1));
	    if(level==0){
	...
	if(cmd.equals("chgrp") || cmd.equals("chown") || cmd.equals("chmod")){
	  ...
	  if(cmd.equals("chmod")){
	    ...
	    if(foo==-1)continue;
  	    ...
  	    try{foo=Integer.parseInt((String)cmds.get(1));}
	...
	if(cmd.equals("pwd") || cmd.equals("lpwd") || cmd.equals("1")){
           str=( (cmd.equals("pwd") || cmd.equals("1"))?"Remote":"Local");
	   str+=" working directory: ";
          if(cmd.equals("pwd") || cmd.equals("1")) str+=c.pwd();
	  else str+=c.lpwd();
	  out.println(str);
	  continue;
	}
	if(cmd.equals("ls") || cmd.equals("dir")){
	  String path=".";
	  if(cmds.size()==2) path=(String)cmds.get(1);
	  try{
...
//	  String p2=p1;
	  String p2=".";
	  if(cmds.size()==3)p2=(String)cmds.get(2);
	  try{
...
"?                             Synonym for help";
  ...
  public static LinkedList<String> getCommand() {
      ...
      System.out.println(">>> read");
        ...
        try {
            ...
            com= con.readLine(); System.out.println(com);
            ...
            if(com != null){
                ...
                for(int i=0;i<com.length();i++){
                    ...
                    if(com.charAt(i) == ' '){
                        list.add(bff); System.out.println(">>>C: "+bff);
                        bff="";
                        com = com.substring(i).trim();
                        i=-1;
                    }else{
                        
                        bff=bff+com.charAt(i);
            ...
            java.util.logging.Logger.getLogger(SFTP_try.class.getName()).log(Level.SEVERE, null, ex);
        }
